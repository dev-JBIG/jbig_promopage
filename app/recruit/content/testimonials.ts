...
export const testimonialItems: readonly TestimonialItem[] = [
  ...
  },
  {
    ...
    review: "JBIG 활동을 하면서 얻은 것을 하나만 꼽자면, 새로운 이론이나 기술을 배운 경험도 있지만 다양한 사람들을 만날 수 있었다는 점이 가장 좋았던 것 같습니다. 함께 공모전에 참가할 사람을 구하기도 하고, 단체 채팅방에서 새로운 기술에 관해 이야기를 나누기도 했습니다. 개강총회나 종강총회에서는 편하게 잡담을 하다가도, 어느 순간 최신 인공지능 기술이나 대학원 진학 이야기를 하고 있곤 했습니다. 생각해 보면 조금 너드 같은 모임이기는 하지만(물론 재미도 있습니다. 저 빼고 다 인싸였음 ㅜ) 비슷한 관심사를 가진 사람들과 기술부터 진로, 별것 아닌 이야기까지 자연스럽게 나눌 수 있었던 점이 JBIG 활동의 가장 큰 매력이었던 것 같습니다.",
  },
  {
    id: "member-04",
    name: "국*",
